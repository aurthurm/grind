...
const EditorCK = dynamic(() => import("../../components/editors/EditorCK"), {
  ssr: false,
});
...
const AddErrandForm = ({
  ...
  const onFinish = (values: any) => {
    saveErrandMutation({
      variables: { payload: { ...values, category, ...extras } },
    })
      .then((result) => {
      ...
      >
        ...
        >
          ...
          <Form.Item
            name="description"
            rules={[
              { required: true, message: "Errand Description is required!" },
            ]}
          >
          ...
          <div className="flex">
            {["PROJECT"].includes(category) ? (
              <Form.Item
                ...
                rules={[
                  {
                    required: ["PROJECT"].includes(category),
            ...
            {["PROJECT", "TICKET"].includes(category) ? (
              <Form.Item
                ...
                rules={[
                  {
                    required: ["PROJECT", "TICKET"].includes(category),
