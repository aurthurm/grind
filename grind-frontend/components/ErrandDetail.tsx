...
import { Avatar, Button, Divider, Menu, MenuProps, message } from 'antd';
...
const ErrandDetail = () => {
  const [openDiscussionForm, setOpenDiscussionForm] = useState(false);
        ...
        <article className="px-64">
          ...
          <div className="mt-12 text-justify text-lg">
            ...
            <div>
              ...
              <Button className=" flex items-center mt-2 bg-white" shape="round" icon={<EyeOutlined />} size='small' onClick={() => {
                setIsEditing(false);
